...
const infoData = [
  ...
  },
  {
    ...
    text: "alihusban458@gmail.com",
  },
  {
    icon: <Calendar size={20} />,
    text: "Born 30 May 2004",
  },
  {
              ...
              <div className="text-lg mt-12 xl:mt-8">
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                      Aspiring MERN stack dev passionate about building
                      end-to-end web solutions.
                    </h3>
                    <p className="text-base md:text-lg mb-6 max-w-xl mx-auto xl:mx-0">
                      I&apos;m an up-and-coming MERN stack developer with a
                      passion for building comprehensive web solutions. I bring
                      enthusiasm, a solid foundation in both front-end and
                      back-end technologies, and a strong drive to learn.
                      I&apos;m eager to contribute to innovative projects while
                      continuously expanding my expertise across the entire web
                      development stack.
                    </p>
                    <div className="gap-y-4 mb-12 grid md:grid-cols-2">
                      {infoData.map((item, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-x-4 mx-auto xl:mx-0 max-w-sm"
                        >
                ...
                <TabsContent value="skills">
                  <div className="text-center xl:text-left">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold text-center xl:text-left mb-2">
                        What I am good at!
                      </h4>
                      <div className="border-b border-border mb-4 "></div>
