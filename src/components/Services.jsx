...
const servicesData = [
  {
    ...
    description:
      "Seamlessly connect and enhance your applications with robust API integrations that streamline data flow and expand functionality.",
  },
  {
    icon: <Gem />,
    title: "Frontend Designs",
    description:
      "Transform your ideas into stunning digital experiences with expertly crafted frontend designs that captivate and engage your audience.",
  },
  {
    icon: <Blocks />,
    title: "MERN Stack Web Apps",
    description:
      "Build comprehensive, dynamic web applications from the ground up with full stack development solutions that cover both client-side and server-side needs.",
  },
];
